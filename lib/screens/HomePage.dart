                ...
                Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                        ...
                        child: myCard(colorApp.green1, colorApp.green2, TextApp.bookOneScreen.data ,"assets/quran.png",'assets/svg/one.svg')),
                    InkWell(
                        onTap: (){
...
Widget myCard (Color color1,color2,String text,path1,path2,){
  return Padding(
    ...
    ,style: const TextStyle(color: colorApp.offWhite,fontWeight: FontWeight.bold,fontSize: 22),),
